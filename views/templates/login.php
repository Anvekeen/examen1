    ...
    <form id="LoginForm" action="/examen1/portal" method="post">
        ...
        <div class="float-right">
            <span id="subscribe" class="sub text-muted">Nouveau sur le site? Inscrivez-vous maintenant !</span>
            <button type="button" class="sub btn btn-primary" id='ShowSubForm'>Inscription</button>
        </div>
    </form>
</div>
