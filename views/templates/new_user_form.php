...
<div class="container p-3">
    ...
    <form id="NewUserForm"  action="/Examen1/index" method="post">
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="InputEmailSub" name="InputEmailSub" placeholder="Entrez votre adresse mail" required>
        </div>
        <div class="form-group">
            <label for="InputPasswordSub">Mot de passe :</label>
            <input type="password" class="form-control" id="InputPasswordSub" name="InputPasswordSub" placeholder="Mot de passe" required>
        </div>
        <span>Vous êtes... :</span>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="InputType" id="InputType1" value="2" checked>
            <label class="form-check-label" for="InputType1">
                Un locataire
            </label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="InputType" id="InputType2" value="3">
            <label class="form-check-label" for="InputType2">
                Un propriétaire (résident)
            </label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="InputType" id="InputType3" value="4">
        ...
        <div class="form-group col-md-4">
            ...
            <select id="InputBuilding" class="form-control" name="InputBuilding" required>
                <?php foreach ($buildings as $building): ?>
                <option><?= $building->__get('buildingname'); ?></option>
                <?php endforeach; ?>
            </select>
            ...
            <input type="number" class="form-control" id="InputAppart" name="InputAppart" >
        </div>
        </div>
